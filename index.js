...
const program = cli({
  ...
  options: [
    ...
    {
      flags: '--cypress',
      description: 'generate cypress http client',
      default: codeGenBaseConfig.httpClientType === HTTP_CLIENT.CYPRESS,
    },
    {
    ...
    switch (command) {
      case null: {
        await generateApi({
          ...
          httpClientType: options.axios ? HTTP_CLIENT.AXIOS : ( options.cypress ? HTTP_CLIENT.CYPRESS :  HTTP_CLIENT.FETCH),
